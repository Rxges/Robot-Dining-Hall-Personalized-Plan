...
: ${AMENT_CURRENT_PREFIX:="/home/4_fri/bwi_ros2/install/bwi_launch"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bwi_launch/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/bwi_launch/environment/path.sh"
