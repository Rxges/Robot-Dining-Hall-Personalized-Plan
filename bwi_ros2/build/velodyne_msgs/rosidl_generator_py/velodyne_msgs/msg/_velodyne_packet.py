...
class Metaclass_VelodynePacket(type):
    """Metaclass of message 'VelodynePacket'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('velodyne_msgs')
        except ImportError:
            import logging
            import traceback
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__msg__velodyne_packet
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__msg__velodyne_packet
            cls._CONVERT_TO_PY = module.convert_to_py_msg__msg__velodyne_packet
            cls._TYPE_SUPPORT = module.type_support_msg__msg__velodyne_packet
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__msg__velodyne_packet
...
class VelodynePacket(metaclass=Metaclass_VelodynePacket):
    """Message class 'VelodynePacket'."""
